...
Each website names their elements differently so I had to use window.location.hostname to get the url of the website that is being visited and I used that url to 
